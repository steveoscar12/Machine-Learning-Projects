...
%CHANGE MATLAB code file for change.fig
...
%
%      CHANGE('Property','Value',...) creates a new CHANGE using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to change_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      CHANGE('CALLBACK') and CHANGE('CALLBACK',hObject,...) call the
%      local function named CALLBACK in CHANGE.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 18-Jul-2018 18:52:07
...
set(handles.newF,'string',newFileName);
...
% handles    structure with handles and user data (see GUIDATA)
fileName = get(handles.edit2,'string');
calibration = str2double(get(handles.edit1,'string'));
updateFile(fileName,calibration);
